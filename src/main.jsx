...
import { createRoutesFromElements, Route, RouterProvider,createBrowserRouter, Routes } from 'react-router-dom'
   ...
   <>
      ...
      <Route element={<AdminLayout />}>
        ...
        <Route path="/admin-dashboard/bus/view-all" element={<BusList />} />
          ...
          <Route path="/admin-dashboard/bus/update/:busId" element={<BusUpdate/>} />
          
        </Route>

        <Route element={<AdminStudentLayout />}>
          <Route path="/admin-dashboard/student/view-all" element={<StudentList />} />
          <Route path="/admin-dashboard/student/register" element={<StudentRegister />} />
          <Route path="/admin-dashboard/student/update/:registrationNo" element={<AdminStudentUpdate/>} />
          
        </Route>

        <Route element={<AdminDriverLayout />}>
          <Route path="/admin-dashboard/driver/view-all" element={<DriverList />} />
          <Route path="/admin-dashboard/driver/register" element={<AdminDriverRegister />} />
          <Route path="/admin-dashboard/driver/update/:driverId" element={<AdminDriverUpdate/>} />
